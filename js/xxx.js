let temp = document.querySelector('.display-all');
let input = document.querySelector('.display');
let button = document.querySelectorAll('.calculator');
let tempText = '';
let resultText = '';
...
document.querySelector('.num-pad').addEventListener('click',mainCalc);
